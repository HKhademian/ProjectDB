...
public class EndorseCellController extends JFXListCell<User> {

    private User visitor;

    public EndorseCellController(User visitor) {
    ...
    public void updateItem(User user, boolean empty){
        ...
        if(empty || user == null){
            ...
            if(fxmlLoader == null){
                fxmlLoader = new FXMLLoader(getClass().getResource("../../../view/cells/EndorseCell.fxml"));
