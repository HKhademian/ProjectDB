...
object UserRepository {
	...
	fun register(
		...
		register(User(0, username, firstname, lastname, intro, about, birthday, location), password)
	...
	@JvmStatic
	fun toggleLike(userId: Int, articleId: Int, commentId: Int): Boolean {
		val SQL1: String
		val SQL2: String
		val SQL3: String
		if (commentId > 0) {
	...
	fun getNotification(userId: Int): List<Notification> {
